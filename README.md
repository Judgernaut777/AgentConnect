...
tests/                       # 104 unit + e2e tests, run offline (stub backend + mTLS)
...
pytest -q                      # 104 passing, fully offline
...
**All six phases implemented end-to-end (offline, tested — 104 tests):** the
