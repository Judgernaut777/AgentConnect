...
{shell_action}{tests_action}{browser_action}{memory_action}{{"action": "finish", "summary": "<what you did / found>", "confidence": <0.0-1.0>, "risks": ["<risk>", ...], "recommended_next_action": "<optional>"}}
